 ...
 *
 * The S3 SoftAP workarounds (AMPDU off, NVS off, HT20, country FI, 19.5 dBm)
 * were validated in xbox-switch-bridge ADR-0007 and lifted verbatim —
 * without them the AP is invisible on ESP32-S3 (espressif/esp-idf#13508).
 *
 * Adapted from xbox-switch-bridge/components/log_udp.
 */
#include "log_udp.h"
...
#define LOG_AP_SSID "espdancer-log"
#define LOG_AP_PASS "espdancer"
