/**
 * @file wifi_manager.h
 * @brief WiFi connectivity manager for ThinkPack Brainbox
 *
...
#define WIFI_HOSTNAME "thinkpack-brainbox"  // Device hostname
 ...
 *
 * For interactive applications, WIFI_POWER_MAX_PERFORMANCE is recommended
