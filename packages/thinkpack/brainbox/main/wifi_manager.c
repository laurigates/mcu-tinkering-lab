/**
 * @file wifi_manager.c
 * @brief WiFi connectivity manager implementation for ThinkPack Brainbox
 *
 * Implements robust WiFi connectivity with automatic reconnection,
 * credential management, and power optimization.
 */
...
esp_err_t wifi_manager_init(void)
{
    ...
    // Disable WiFi power save by default for interactive use (low latency, reliable
