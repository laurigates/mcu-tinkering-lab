...
```bash
cat > packages/robocar/camera/main/credentials.h << 'EOF'
...
- [ADR-004: OTA Update Architecture](../../../docs/decisions/ADR-004-ota-update-architecture.md) — Design rationale
