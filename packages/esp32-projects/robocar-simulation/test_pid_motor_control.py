...
def test_motor_controller_standalone():
    ...
    try:
        ...
        print(
            f"  ✅ Velocity control: target={target_velocity:.2f}, measured={measured_velocity:.2f}"
        )
...
def test_robot_pid_integration():
    ...
    try:
        ...
        print(
            f"  📊 Left motor: target={left_velocity:.2f}, measured={left_vel:.2f}, error={left_error:.2f}"
        )
        print(
            f"  📊 Right motor: target={right_velocity:.2f}, measured={right_vel:.2f}, error={right_error:.2f}"
        )
...
def test_position_control():
    ...
    try:
        ...
        print(
            f"  📊 Left position: target={target_left:.1f}°, measured={left_pos:.1f}°, error={left_error:.1f}°"
        )
        print(
            f"  📊 Right position: target={target_right:.1f}°, measured={right_pos:.1f}°, error={right_error:.1f}°"
        )
