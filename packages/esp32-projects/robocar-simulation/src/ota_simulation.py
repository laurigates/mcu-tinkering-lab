...
class OTASimulation:
    ...
    def _save_ota_data(self):
        ...
        try:
            ...
            self.error_handler.handle_error(
                "ota_simulation", "ota_data_save_failed",
    ...
    def is_ota_ready(self) -> bool:
        ...
        try:
            ...
            self.error_handler.handle_error(
                "ota_simulation", "ota_ready_check_failed",
    ...
    def start_update(self, firmware_url: str, version: str = None) -> bool:
        ...
        try:
            ...
            self.download_thread = threading.Thread(
                target=self._simulate_download,
                args=(firmware_url, firmware_info),
                daemon=True
            )
            ...
            self.error_handler.handle_error(
                "ota_simulation", "ota_start_failed",
        ...
        try:
            ...
            while bytes_downloaded < total_bytes and not self.abort_download:
                ...
                if progress % 10 == 0 and progress > 0:
                    print(f"OTA simulation: Download progress {progress}% "
            ...
            self.error_handler.handle_error(
                "ota_simulation", "download_simulation_failed",
    ...
    def _handle_download_success(self, firmware_info: FirmwareInfo):
        ...
        try:
            ...
            self.ota_data["seq"] += 1
            self.ota_data[self.ota_partition] = {
                "valid": True,
                "seq": self.ota_data["seq"]
            }
            ...
            self.error_handler.handle_error(
                "ota_simulation", "ota_success_handling_failed",
    ...
    def abort_update(self) -> bool:
        ...
        try:
            ...
            self.error_handler.handle_error(
                "ota_simulation", "ota_abort_failed",
    ...
    def set_boot_partition(self, partition_name: str) -> bool:
        ...
        try:
            ...
            print(f"OTA simulation: Boot partition changed from {old_partition} to {partition_name}")
            ...
            self.error_handler.handle_error(
                "ota_simulation", "boot_partition_change_failed",
    ...
    def rollback_to_factory(self) -> bool:
        ...
        try:
            ...
            self.error_handler.handle_error(
                "ota_simulation", "factory_rollback_failed",
...
def main():
    ...
    try:
        ...
        for name, partition in info['partitions'].items():
            print(f"  {name}: {partition['type']}/{partition['subtype']} "
