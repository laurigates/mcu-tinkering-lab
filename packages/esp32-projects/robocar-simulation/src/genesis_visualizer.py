    ...
    def start_update_loop(self):
        ...
        def animate(frame):
            try:
                ...
                self.direction_line = self.ax.arrow(state.x, state.y, dx, dy, 
                ...
                if len(self.trail_points) > 1:
                    ...
                    self.trail_line, = self.ax.plot(trail_x, trail_y, 'g-', alpha=0.5, linewidth=2)
