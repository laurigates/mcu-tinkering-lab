...
- `packages/components/thinkpack-protocol/` -- packet definitions, checksums, capability flags
- `packages/components/thinkpack-mesh/` -- ESP-NOW init, beacon, peer management, leader election
- `packages/components/thinkpack-behaviors/` -- collective behavior engine, command dispatch
...
- [PRD-010: ThinkPack Modular Toy Boxes](../requirements/PRD-010-thinkpack-modular-toys.md)
