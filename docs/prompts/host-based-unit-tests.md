...
- `packages/robocar/components/i2c-protocol/` — I2C protocol encode/decode
- `packages/input-gaming/xbox-switch-bridge/components/switch_pro_usb/` — Switch protocol parsing

### Phase 2: Project-level component coverage
- `packages/robocar/main/components/` — motor control logic, PID controller
