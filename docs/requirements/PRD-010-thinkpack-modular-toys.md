...
|---------|----------|----------|
| `thinkpack-protocol` | `packages/components/thinkpack-protocol/` | Packet format, message types, capability flags, checksum helpers |
| `thinkpack-mesh` | `packages/components/thinkpack-mesh/` | ESP-NOW init, beacon, peer management, leader election, group manager |
| `thinkpack-behaviors` | `packages/components/thinkpack-behaviors/` | Collective behavior engine, command dispatcher, command executor |

### Code Reuse from Existing Projects

| Component | Source | Target |
|-----------|--------|--------|
| Packed struct + XOR checksum | `components/i2c-protocol/include/i2c_protocol.h` | `thinkpack-protocol` |
...
| Improv WiFi provisioning | `components/improv-wifi/` | Brainbox |
...
- [ADR-014: ThinkPack ESP-NOW Mesh](../decisions/ADR-014-thinkpack-espnow-mesh.md)
- [ADR-007: Shared I2C Protocol Component](../decisions/ADR-007-shared-i2c-protocol-component.md) (pattern reference)
- [ADR-003: Pluggable AI Backends](../decisions/ADR-003-pluggable-ai-backends.md) (pattern reference)
