...
#### 1.1 New file: `packages/esp32-projects/robocar-camera/main/ota_manager.h`
...
#### 1.2 New file: `packages/esp32-projects/robocar-camera/main/ota_manager.c`
...
#### 1.3 Config additions: `packages/esp32-projects/robocar-camera/main/config.h`
...
#### 1.4 Modify: `packages/esp32-projects/robocar-camera/sdkconfig.defaults`
...
#### 1.5 Modify: `packages/esp32-projects/robocar-camera/main/CMakeLists.txt`
...
#### 1.6 Modify: `packages/esp32-projects/robocar-camera/main/main.c`
...
#### 2.1 New file: `packages/esp32-projects/robocar-main/main/ota_handler.h`
...
#### 2.2 New file: `packages/esp32-projects/robocar-main/main/ota_handler.c`
...
#### 2.3 Config additions: `packages/esp32-projects/robocar-main/main/system_config.h`
...
#### 2.4 Modify: `packages/esp32-projects/robocar-main/sdkconfig.defaults`
...
#### 2.5 Modify: `packages/esp32-projects/robocar-main/main/CMakeLists.txt`

Add `ota_handler.c` to SRCS. Add `esp_https_ota`, `cJSON`, `esp_wifi` to REQUIRES.

#### 2.6 Modify: `packages/esp32-projects/robocar-main/main/main.c`
...
#### 5.1 New file: `docs/blueprint/adrs/ADR-004-ota-update-architecture.md`
...
| File | Purpose |
|------|---------|
| `packages/esp32-projects/robocar-camera/main/ota_manager.h` | Camera OTA orchestration API |
| `packages/esp32-projects/robocar-camera/main/ota_manager.c` | MQTT sub, periodic check, download, flash, orchestrate main |
| `packages/esp32-projects/robocar-main/main/ota_handler.h` | Main controller OTA handler API |
| `packages/esp32-projects/robocar-main/main/ota_handler.c` | I2C OTA command handler, WiFi init, download, flash |
| `.github/workflows/esphome-build.yml` | Reusable ESPHome CI/CD workflow template |
| `docs/blueprint/adrs/ADR-004-ota-update-architecture.md` | Architecture decision record |

### Modified Files (8)
| File | Change |
|------|--------|
| `packages/esp32-projects/robocar-camera/main/config.h` | Add OTA config constants |
| `packages/esp32-projects/robocar-camera/main/main.c` | Add `ota_manager_init()`, rollback confirmation |
| `packages/esp32-projects/robocar-camera/main/CMakeLists.txt` | Add ota_manager.c, esp_https_ota dep |
| `packages/esp32-projects/robocar-camera/sdkconfig.defaults` | Enable rollback + cert bundle |
| `packages/esp32-projects/robocar-main/main/system_config.h` | Add OTA config constants |
| `packages/esp32-projects/robocar-main/main/main.c` | Add `ota_handler_init()`, rollback confirmation |
| `packages/esp32-projects/robocar-main/main/CMakeLists.txt` | Add ota_handler.c, esp_https_ota + wifi deps |
| `.github/workflows/build-firmware.yml` | MQTT notification step, improved manifest.json |

### Potentially Modified (if needed)
| File | Change |
|------|--------|
| `packages/esp32-projects/robocar-main/sdkconfig.defaults` | Create if doesn't exist, add OTA + cert configs |
| `packages/esp32-projects/robocar-camera/main/Kconfig.projbuild` | Add OTA menu for GitHub repo URL config |
